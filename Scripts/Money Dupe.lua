-- This is not my script all credit goes to the respected author, Hacker#8326

-- Added back since I cannot get Extreme LT2s money dupe to work 
...
game:GetService("StarterGui"):SetCore("SendNotification",{
                Title = "By Hacker#8326",
                Text = "Load Your Save and wait until you receive your money.",
                Duration = 15,
                })
end
end
